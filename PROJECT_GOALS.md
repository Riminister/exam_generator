...
```
Exam Bank Data → ML Analysis → Question Generation → Chatbot Interface → New Exams
     ↓              ↓              ↓              ↓              ↓
...
- **Difficulty Consistency**: Generated questions match target difficulty ±1 level

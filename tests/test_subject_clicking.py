# Test Clicking on Subject Categories to Find Actual Exams
import time
from parse import QueensExamBankDownloader
from bs4 import BeautifulSoup
import re

def test_subject_clicking():
    """Test clicking on subject categories to find actual exams"""
    print("Testing Subject Category Clicking")
    print("Navigation: Home -> Communities & Collections -> Exams & Syllabi -> By Subject -> Click Subject")
    print("=" * 80)
    ...
    try:
        ...
        # Step 3: Look for "Applied Science" subject (likely contains ELEC371)
        ...
        # Step 5: Try other subjects that might contain ELEC371
        print("\nStep 5: Trying other subjects...")
        
        # Go back to subject list
        downloader.driver.get("https://qspace.library.queensu.ca/browse/subject?scope=699fe318-6bf1-45b5-9b17-61f0d2246003")
        time.sleep(3)
        
        # Try "Computing" subject
        links = downloader.driver.find_elements("tag name", "a")
        computing_link = None
        ...
        for link in links:
            try:
                ...
                if "Computing" in text:
                    computing_link = link
                    print(f"Found Computing link: '{text}'")
                    break
            except:
                continue
        ...
        if computing_link:
            ...
            if exam_links:
                print(f"Found {len(exam_links)} exam links in Computing!")
                ...
                print("No exam links found in Computing")
